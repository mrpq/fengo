...
var _siem = require("siem");

var _siem2 = _interopRequireDefault(_siem);
...
var fromBlogSliderInit = function fromBlogSliderInit() {
  ...
  var siema = new _siem2.default({ selector: ".js-from-blog-slider" });
...
document.addEventListener('DOMContentLoaded', fromBlogSliderInit);
document.addEventListener('DOMContentLoaded', favSliderInit);
"use strict";
...
var initHomePageSlider = function initHomePageSlider() {
  try {
    var siemaHomePageSlider = new _siema2.default({
...
var initProductBlockSlides = function initProductBlockSlides() {
  try {
    var productSliders = document.querySelectorAll(".js-siema-product");
    if (!productSliders) throw new Error();
    var productSledersControls = document.querySelectorAll(".product-slider-controls");
    productSliders.forEach(function (elem, i) {
      var selector = "js-siema-product-" + i;
      elem.classList.add(selector);
      var siema = new _siema2.default({ selector: "." + selector });
      productSledersControls[i].children[0].addEventListener("click", function () {
        siema.goTo(0);
      });
      productSledersControls[i].children[1].addEventListener("click", function () {
        siema.goTo(1);
      });
      productSledersControls[i].children[2].addEventListener("click", function () {
        siema.goTo(2);
      });
    });
  } catch (e) {
...
document.addEventListener('DOMContentLoaded', initProductBlockSlides);
